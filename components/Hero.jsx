...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center py-2 md:py-16 lg:py-20 bg-[#DFEECB] rounded-lg shadow-bottom shadow-black-500/50">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="text-center md:text-left">
          <h2 className="font-syne text-4xl font-bold tracking-tight text-[#103535] sm:text-8xl md:text-10xl">
            BRINGING <br />
